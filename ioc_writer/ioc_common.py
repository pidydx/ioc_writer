...
def make_dnsentryitem_recordname(dns_name, condition='contains', negate=False, preserve_case = False):
    ...
    content_type = 'string'
    content = dns_name
    IndicatorItem_node = ioc_et.make_IndicatorItem_node(condition, document, search, content_type, content, negate=negate, preserve_case=preserve_case)
...
def make_eventlogitem_eid(eid, condition='is', negate=False):
    ...
    content_type = 'int'
    content = eid
    IndicatorItem_node = ioc_et.make_IndicatorItem_node(condition, document, search, content_type, content, negate=negate)
    return IndicatorItem_node
